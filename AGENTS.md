...
- `packages/profile`: account-owned personal homepage maintenance and public profile display.
...
- Profile app: `packages/profile`, port `5176`, base `/profile/`.
